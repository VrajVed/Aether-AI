  ...
  return (
    <>
      ...
      <div className="justify-center flex text-white mt-40 items-center flex-col">
        <h1 className="font-bold font text-5xl mt-[-20px] ">Your AI, Visualized.</h1>
        ...
        <div
          className="rounded-full pointer-events-none z-0 bg-[#00FF443F]
                          sm:w-[408px] sm:h-[222px] sm:top-[-99px]
                          md:w-[675px] md:h-[250px] md:top-[700px] md:right-[410px]
                          absolute blur-[160px]"
        ></div>
        <img src="/test.png" width={500} height={300} className="p-3  mt-10 rounded-4xl border-2 border-amber-50 " alt="demo"/>
